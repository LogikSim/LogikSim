...
describe("A simulation with workers", function() {
    ...
    it("should be able to do basic asynchronous simulation", function(done) {
        var simulation = new LogikSim.Backend.Simulation('base/src/scripts/');
    ...
    it("should be able to do basic no-web-worker simulation", function(done) {
        var simulation = mk_synchronous_test_simulation('base/src/scripts/');
